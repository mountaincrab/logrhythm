...
private val MIGRATION_6_7 = object : Migration(6, 7) {
    override fun migrate(connection: SQLiteConnection) {
        connection.execSQL("ALTER TABLE poop_tags ADD COLUMN syncStatus TEXT NOT NULL DEFAULT 'PENDING'")
        connection.execSQL("ALTER TABLE poop_tags ADD COLUMN updatedAt INTEGER NOT NULL DEFAULT 0")
        connection.execSQL("ALTER TABLE note_tags ADD COLUMN syncStatus TEXT NOT NULL DEFAULT 'PENDING'")
        connection.execSQL("ALTER TABLE note_tags ADD COLUMN updatedAt INTEGER NOT NULL DEFAULT 0")
    }
}
