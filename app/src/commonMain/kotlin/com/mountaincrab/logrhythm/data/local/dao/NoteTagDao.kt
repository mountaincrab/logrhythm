...
interface NoteTagDao {
     ...
     */
    @Query("SELECT * FROM note_tags WHERE profileId = :profileId ORDER BY sortOrder ASC, createdAt ASC")
    fun observeForLookup(profileId: String): Flow<List<NoteTagEntity>>
