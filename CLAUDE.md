...
app/src/
  commonMain/kotlin/com/mountaincrab/logrhythm/
    data/
      ...
      local/dao/{Poop,Food,Note}EntryDao.kt
      local/entity/{Poop,Food,Note}EntryEntity.kt
...
```
poop_entries   ← id, userId, occurredAt, bristol, rating, notes, medsMissed, caffeine, alcohol, syncStatus, isDeleted, …
food_entries   ← id, userId, occurredAt, items, mealTag, syncStatus, isDeleted, …
note_entries   ← id, userId, occurredAt, content, syncStatus, isDeleted, …
```
